...
public class JdbcClientDao implements ClientDao {
    ...
    private static final String SQL_LIST_CLIENTS = "SELECT * FROM client ORDER BY company_name";
    ...
    private static final String SQL_UPDATE_CLIENT = "UPDATE client SET (company_name, website_uri, phone_number, street_address, city, state, zip_code, contact_list)"
                                                  + " = (:companyName, :websiteUri, :phoneNumber, :streetAddress, :city, :state, :zipCode, :contactListString)"
                                                  + " WHERE client_id = :clientId";
    private static final String SQL_CREATE_CLIENT = "INSERT INTO client (company_name, website_uri, phone_number, street_address, city, state, zip_code, contact_list)"
                                                  + " VALUES (:companyName, :websiteUri, :phoneNumber, :streetAddress, :city, :state, :zipCode, :contactListString)";
    ...
    private static final class ClientRowMapper implements RowMapper<Client> {
        ...
        public Client mapRow(ResultSet rs, int rowNum) throws SQLException {
            ...
            client.setContactListString(rs.getString("contact_list"));
            return client;
        }
    }
}
