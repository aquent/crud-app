...
<html lang="en">
	<head>
		...
		<title>Companies | Crud Application</title>
	...
	<body>
		...
		<div class="container">
			<div>
				<h1>Companies</h1>
				<p><a class="btn btn-primary" href="${pageContext.request.contextPath}/company/create">Create New Company</a></p>
				<c:choose>
				            ...
				            <tbody>
				                <c:forEach items="${companies}" var="company">
				                    <tr>
				                        ...
				                        <td>
				                            <a class="btn btn-default" href="${pageContext.request.contextPath}/company/view/${company.companyId}">View Company</a>
